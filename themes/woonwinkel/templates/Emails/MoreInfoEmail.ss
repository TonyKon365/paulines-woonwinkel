    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td>
                <table style="margin: 0 auto; font-family: Arial; " width="600">
                    ...
                    <tr>
                        <td colspan="2"><h2 style="margin-left: 20px;">Informatie aanvraag</h2></td>
                    </tr>
                    <tr>
                        <th>Naam:</th>
                        <td>$Name</td>
                    ...
                    <tr>
                        <th>Product:</th>
                        <td><a href="$ProductLink">$Product</a></td>
                    </tr>
                    <tr>
                        <th>Bericht:</th>
                        <td>$Message</td>
